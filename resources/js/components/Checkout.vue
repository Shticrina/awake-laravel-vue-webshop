            ...
            <div class="col-12 col-sm-9 text-center">
                <div class="card pt-5 mb-5" id="wizard">
                    ...
                    <div v-else>
                        ...
                        <fieldset v-if="isLoggedIn" id="finish" class="px-5">
...
<script>
    ...
    window.checkBc = function(data) {
        if (data === 'succeeded') {
            ...
            console.log('checkBcResult in window.checkBc: ', checkBcResult);
        ...
        if (typeof checkBcResult !== 'undefined') {
    ...
    export default {
        ...
        async mounted() {
            ...
            console.log('bc_status: ', this.bc_status);
